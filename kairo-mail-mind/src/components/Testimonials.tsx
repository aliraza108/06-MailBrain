...
const testimonials = [
  {
    ...
    company: "TechCorp",
    content:
      "KAIRØ has saved me at least 10 hours per week. The AI understands context perfectly and my emails sound exactly like me.",
    rating: 5,
  },
  {
    name: "Michael Chen",
    ...
    company: "StartupXYZ",
    content:
      "Game changer for my startup. I can focus on building while KAIRØ handles all my email correspondence intelligently.",
    rating: 5,
  },
  {
    ...
    <section ref={containerRef} className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            See what our users have to say about their experience with KAIRØ
          </motion.p>
        </motion.div>
