...
const faqs = [
  {
    question: "How does KAIRØ understand my writing style?",
    answer:
      "KAIRØ uses advanced AI to analyze your previous emails and learn your unique tone, vocabulary, and communication patterns. The more you use it, the better it gets at matching your style.",
  },
  {
  ...
  {
    question: "Can I use KAIRØ with multiple email accounts?",
    answer:
    ...
    <section id="faq" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            Everything you need to know about KAIRØ
          </motion.p>
        </motion.div>
